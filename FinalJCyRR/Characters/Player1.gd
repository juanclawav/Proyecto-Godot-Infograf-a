...
var bullet = preload("res://Characters/Bullet1.tscn")
...
func _physics_process(_delta):
	...
	var enemy = get_tree().get_root().find_node("Player2", true, false)
...
func enemy_killed():
	var enemylives_remaining = get_parent().get_node("Player2").get("HP")
